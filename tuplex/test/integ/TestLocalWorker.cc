...
TEST_F(LocalWorkerFixture, GithubGlobalStructs) {
    using namespace std;
    using namespace tuplex;
...
TEST_F(LocalWorkerFixture, GithubGenericDictHyperPushEvents) {
    using namespace std;
    using namespace tuplex;
...
TEST_F(LocalWorkerFixture, GithubSparseStructHyperPushEventsWithS3Source) {
    using namespace std;
    using namespace tuplex;
    ...
    assert(s3impl);
    s3impl->activateReadCache(memStringToSize("256M"));
