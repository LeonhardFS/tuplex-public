...
//             uint8_t* bu
            ...
            /*!
             * helper function to debug print a value in hex
             * @param value what to print
             * @param msg optional message to display along
             */
            void printHexValue(llvm::IRBuilder<>& builder, llvm::Value* value, std::string msg="");
