...
namespace tuplex {
    namespace codegen {
        ...
        extern SerializableValue struct_dict_serialize_to_memory(LLVMEnvironment& env, codegen::IRBuilder& builder, llvm::Value* ptr, const python::Type& dict_type, llvm::Value* dest_ptr);
