...
namespace tuplex {
    namespace codegen {
        ...
        extern std::vector<llvm::Value*> create_bitmap(LLVMEnvironment& env, const IRBuilder& builder, const std::vector<llvm::Value*>& v);
        extern SerializableValue struct_dict_load_from_values(LLVMEnvironment& env, const IRBuilder& builder, const python::Type& dict_type, flattened_struct_dict_decoded_entry_list_t entries, llvm::Value* ptr);

        extern void struct_dict_store_size(LLVMEnvironment& env, const IRBuilder& builder, llvm::Value* ptr, const python::Type& dict_type, const access_path_t& path, llvm::Value* size);
        extern void struct_dict_store_isnull(LLVMEnvironment& env, const IRBuilder& builder, llvm::Value* ptr, const python::Type& dict_type, const access_path_t& path, llvm::Value* is_null);
        extern void struct_dict_store_value(LLVMEnvironment& env, const IRBuilder& builder, llvm::Value* ptr, const python::Type& dict_type, const access_path_t& path, llvm::Value* value);
        ...
        extern SerializableValue struct_dict_serialized_memory_size(LLVMEnvironment& env, const IRBuilder& builder, llvm::Value* ptr, const python::Type& dict_type);

        extern llvm::Value* serializeBitmap(LLVMEnvironment& env, const IRBuilder& builder, llvm::Value* bitmap, llvm::Value* dest_ptr);

        extern void struct_dict_mem_zero(LLVMEnvironment& env, const IRBuilder& builder, llvm::Value* ptr, const python::Type& dict_type);
        ...
        extern SerializableValue struct_dict_deserialize_from_memory(LLVMEnvironment& env, const codegen::IRBuilder& builder, llvm::Value* ptr, const python::Type& dict_type);
        ...
        extern llvm::Value* struct_dict_load_present(LLVMEnvironment& env, const IRBuilder& builder, llvm::Value* ptr, const python::Type& dict_type, const access_path_t& path);
