...
namespace tuplex {
    ...
    private:
        ...
        bool typeFunctionWithSingleParameter(python::Type hintType, std::vector<std::tuple<std::string, python::Type>> params, bool removeBranches, bool printErrors, MessageHandler& logger);
        bool typeFunctionWithMultipleParameters(python::Type& hintType, std::vector<std::tuple<std::string, python::Type>> params, bool removeBranches, bool printErrors, MessageHandler& logger);
