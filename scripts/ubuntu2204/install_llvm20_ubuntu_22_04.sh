...
rm -rf $WORKDIR/tuplex-downloads/*llvm*
mkdir -p $WORKDIR

LLVM_VERSION=20.1.0
LLVM_MAJOR_VERSION=${LLVM_VERSION%%.*}

echo "LLVM Version: $LLVM_VERSION (major: $LLVM_MAJOR_VERSION)"
...
if (( LLVM_MAJOR_VERSION >= 15 )); then
  echo ">>> Fetching cmake files for llvm ${LLVM_MAJOR_VERSION}."
...
# TODO: rename cmake... -> cmake, clang... -> clang dirs
# TODO: make install.
